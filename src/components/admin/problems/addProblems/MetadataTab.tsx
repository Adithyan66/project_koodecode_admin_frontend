  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        {errors.tags && <p className="mb-3 text-sm text-red-500">{errors.tags}</p>}
          ...
          {tags.map((tag, index) => (
            <div key={index} className="flex items-center space-x-2">
              <input
                ...
                className="flex-1 rounded-lg border-2 border-gray-200 px-4 py-3 transition-colors focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-500"
      ...
      <div>
        <div className="mb-4 flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center rounded-lg bg-yellow-500 px-4 py-2 text-white transition-colors hover:bg-yellow-600"
          >
            <Plus className="mr-2 h-4 w-4" />
            Add Hint
          </button>
          ...
          {hints.map((hint, index) => (
            <div key={index} className="flex items-center space-x-2">
              <input
                ...
                className="flex-1 rounded-lg border-2 border-gray-200 px-4 py-3 transition-colors focus:border-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-500"
      ...
      <div>
        <div className="mb-4 flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center rounded-lg bg-indigo-500 px-4 py-2 text-white transition-colors hover:bg-indigo-600"
          >
            <Plus className="mr-2 h-4 w-4" />
            Add Company
          </button>
          ...
          {companies.map((company, index) => (
            <div key={index} className="flex items-center space-x-2">
              <input
                ...
                className="flex-1 rounded-lg border-2 border-gray-200 px-4 py-3 transition-colors focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
