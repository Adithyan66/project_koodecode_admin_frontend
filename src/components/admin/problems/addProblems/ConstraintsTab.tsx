    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center rounded-lg bg-orange-500 px-4 py-2 text-white shadow-md transition-colors hover:bg-orange-600 hover:shadow-lg"
        >
      ...
      {errors.constraints && <p className="text-sm text-red-500">{errors.constraints}</p>}

      <div className="space-y-4">
        {parameterConstraints.map((constraint, index) => (
          <div
            key={index}
            className="rounded-lg border-2 border-gray-200 bg-white p-6 transition-colors hover:border-orange-300"
          >
            <div className="mb-4 flex items-center justify-between">
              <h3 className="flex items-center font-medium text-gray-700">
                <span className="mr-3 rounded-full bg-orange-100 px-3 py-1 text-sm text-orange-800">
                  Constraint {index + 1}
                </span>
              </h3>
              <button
      ...
      {parameterConstraints.length === 0 && (
        <div className="rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-8 text-center">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">No constraints defined</h3>
          <p className="mt-1 text-sm text-gray-500">
